...
def vgg8_bn2(**kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG2(cfg['S'], batch_norm=True, **kwargs)
    return model
...
def vgg11_bn2(**kwargs):
    """VGG 11-layer model (configuration "A") with batch normalization"""
    model = VGG2(cfg['A'], batch_norm=True, **kwargs)
    return model
...
def vgg13_bn2(**kwargs):
    """VGG 13-layer model (configuration "B") with batch normalization"""
    model = VGG2(cfg['B'], batch_norm=True, **kwargs)
    return model
...
def vgg16_bn2(**kwargs):
    """VGG 16-layer model (configuration "D") with batch normalization"""
    model = VGG2(cfg['D'], batch_norm=True, **kwargs)
    return model
...
def vgg19_bn2(**kwargs):
    """VGG 19-layer model (configuration 'E') with batch normalization"""
    model = VGG2(cfg['E'], batch_norm=True, **kwargs)
    return model