...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, T,
        ...
        self.conv1 = conv_bn(4, input_channel, 2)
...
def mobilenetv2_T_w(T, W, feature_dim=100):
    model = MobileNetV2(T=T, feature_dim=feature_dim, width_mult=W, input_size=96)
    return model
...
def mobile_light(num_classes):
    return mobilenetv2_T_w(6, 0.35, num_classes)

def mobile_heavy(num_classes):
