...
class Inception_ResNetv2(nn.Module):
    def __init__(self, in_channels=2, num_classes = 1000, k=256, l=256, m=384, n=384):
...
def inception_resnetv2_2(num_classes):
    return Inception_ResNetv2(num_classes = num_classes)