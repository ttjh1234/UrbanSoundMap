...
import h5py
import joblib
from dataset.sound_hdf5 import get_ml_total_dataloaders
...
def main():
    ...
    test_loader, num_data = get_ml_total_dataloaders(path = './assets/', batch_size= opt.batch_size, num_workers=opt.num_workers, seed=opt.trial)
    model = joblib.load('./assets/ml_model/{}_1000_pool2-{}.pkl'.format(opt.mname,opt.trial))
