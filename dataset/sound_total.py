...
class SoundInstance(Dataset):
    ...
    def __init__(self, path, index_set, t_mean=None, t_std = None,transform=None,target_transform=None):
        ...
        self.total_img=np.load(path+'/total_img10.npy')
        self.total_label=np.load(path+'/total_label.npy')
        self.total_coord=np.load(path+'/total_coord.npy')    
...
class SoundExpansionInstance(Dataset):
    ...
    def __init__(self, path, index_set, t_mean=None, t_std = None,transform=None,target_transform=None):
        ...
        self.total_img=np.load(path+'/total_img1.npy')
        self.total_label=np.load(path+'/total_label.npy')
        self.total_coord=np.load(path+'/total_coord.npy')    
...
class SoundBaseExpandInstance(Dataset):
    ...
    def __init__(self, path, index_set, t_mean=None, t_std = None,transform=None,target_transform=None):
        ...
        self.total_img10=np.load(path+'/total_img10.npy')
        self.total_img1=np.load(path+'/total_img10.npy')
        self.total_label=np.load(path+'/total_label.npy')
        self.total_coord=np.load(path+'/total_coord.npy')    
...
class SoundDetachedOriginInstance(Dataset):
    ...
    def __init__(self, path, index_set, t_mean=None, t_std = None, transform=None,target_transform=None):
        ...
        self.origin_img, self.label, _ = parsing_index(self.total_img, self.total_label, self.total_coord, index_set)

        self.origin_img = self.origin_img/255.0
        
        del self.total_img
        del self.total_label
        del self.total_coord
...
class SoundDetachedInstance(Dataset):
    ...
    def __init__(self, path, index_set, t_mean=None, t_std = None,transform=None,target_transform=None):
        ...
        self.total_img10=np.load(path+'/total_img10.npy')
        self.total_img1=np.load(path+'/total_img1.npy')
        self.total_label=np.load(path+'/total_label.npy')
        self.total_coord=np.load(path+'/total_coord.npy')    
                
        self.expansion_img, self.origin_img, self.label, _ = parsing_index(self.total_img10, 
                                                                                    self.total_label, 
                                                                                    self.total_coord, 
                                                                                    index_set, 
                                                                                    self.total_img1)
        
        del self.total_img10
        del self.total_img1
        del self.total_label
        del self.total_coord
...
def get_detached_origin_sound_dataloaders(path,batch_size=128, num_workers=4, seed=0):
    ...
    test_set = SoundDetachedOriginInstance(path, valid_idx, t_mean = t_mean, t_std = t_std)
